...
# ---------------------------------------------------------------------------------------------------------------------------------------------------"
   ...
   function checkRegistryCredentialsOK() {
        ...
        function printComponentsInstall() {
            ...
            if [[ $INSTALL_MCM == true ]]; 
            then
                echo "    ${GREEN}Component${NC} '${ORANGE}MCM${NC}' will be installed${NC}"
            else
                echo "    ${RED}Component${NC} '${ORANGE}MCM${NC}' ${RED}will NOT be installed${NC}"
            ...
            if [[ $INSTALL_CAM == true ]]; 
            then
                echo "    ${GREEN}Component${NC} '${ORANGE}CAM${NC}' will be installed${NC}"
            else
                echo "    ${RED}Component${NC} '${ORANGE}CAM${NC}' ${RED}will NOT be installed${NC}"
            ...
            if [[ $INSTALL_MIQ == true ]]; 
            then
                echo "    ${GREEN}Component${NC} '${ORANGE}MIQ${NC}' will be installed${NC}"
            else
                echo "    ${RED}Component${NC} '${ORANGE}MIQ${NC}' ${RED}will NOT be installed${NC}"
            ...
            if [[ $INSTALL_APM == true ]]; 
            then
                echo "    ${GREEN}Component${NC} '${ORANGE}APM${NC}' will be installed${NC}"
            else
                echo "    ${RED}Component${NC} '${ORANGE}APM${NC}' ${RED}will NOT be installed${NC}"
            ...
            then
                echo "    ${GREEN}Component${NC} '${ORANGE}LDAP${NC}' will be installed${NC}"
            else
                echo "    ${RED}Component${NC} '${ORANGE}LDAP${NC}' ${RED}will NOT be installed${NC}"

            fi

            if [[ $INSTALL_MCMREG == true ]]; 
            then
                echo "    ${GREEN}Component${NC} '${ORANGE}MCMREG${NC}' will be installed${NC}"
            else
                echo "    ${RED}Component${NC} '${ORANGE}MCMREG${NC}' ${RED}will NOT be installed${NC}"

            fi

            if [[ $INSTALL_ANSIBLE == true ]]; 
            then
                echo "    ${GREEN}Component${NC} '${ORANGE}ANSIBLE${NC}' will be installed${NC}"
            else
                echo "    ${RED}Component${NC} '${ORANGE}ANSIBLE${NC}' ${RED}will NOT be installed${NC}"
    ...
    # ----^-----------------------------------------------------------------------------------------------------------------------------------------------"
        ...
        function waitForComponentReady() {
            ...
            MAXCOUNT=$2    
            ACTCOUNT=0
            echo "${clock}   Waiting for Component ${CYAN}$COMP${NC} being ready."

            checkComponentReady $COMP
            while  [[ $MUST_INSTALL > 0 || $MAXCOUNT > $ACTCOUNT ]]; do 
                checkComponentReady $COMP
                ACTCOUNT=$((ACTCOUNT+1))
                echo "${clock}   Still checking for Component ${CYAN}$COMP${NC} being ready ($ACTCOUNT/$MAXCOUNT). Waiting for 15 seconds...."
                sleep 15
            done
