...
server_url = 'http://icp-proxy.cp4mcp-demo-002-a376efc1170b9b8ace6422196c51e491-0000.us-south.containers.appdomain.cloud:80'
...
all_cluster_data = [r['uid'] for r in k8s_resources if 'uid' in r.keys() and r['uid'].split('_')[0] == provider_id]
