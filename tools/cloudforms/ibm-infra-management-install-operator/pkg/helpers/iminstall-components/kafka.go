...
func DefaultKafkaSecret(cr *iminstallv1alpha1.IMInstall) *corev1.Secret {
...
func kafkaSecretName(cr *iminstallv1alpha1.IMInstall) string {
...
func KafkaPVC(cr *iminstallv1alpha1.IMInstall) *corev1.PersistentVolumeClaim {
	labels := map[string]string{
		"app": cr.Spec.AppName,
	}
...
func ZookeeperPVC(cr *iminstallv1alpha1.IMInstall) *corev1.PersistentVolumeClaim {
	labels := map[string]string{
		"app": cr.Spec.AppName,
	}
...
func KafkaService(cr *iminstallv1alpha1.IMInstall) *corev1.Service {
	labels := map[string]string{
		"app": cr.Spec.AppName,
	}
...
func ZookeeperService(cr *iminstallv1alpha1.IMInstall) *corev1.Service {
	labels := map[string]string{
		"app": cr.Spec.AppName,
	}
	selector := map[string]string{
...
func KafkaDeployment(cr *iminstallv1alpha1.IMInstall) (*appsv1.Deployment, error) {
...
func ZookeeperDeployment(cr *iminstallv1alpha1.IMInstall) (*appsv1.Deployment, error) {
