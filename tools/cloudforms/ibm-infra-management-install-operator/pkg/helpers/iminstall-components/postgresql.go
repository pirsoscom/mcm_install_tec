...
func DefaultPostgresqlSecret(cr *iminstallv1alpha1.IMInstall) *corev1.Secret {
...
func postgresqlSecretName(cr *iminstallv1alpha1.IMInstall) string {
...
func NewPostgresqlConfigsConfigMap(cr *iminstallv1alpha1.IMInstall) *corev1.ConfigMap {
	labels := map[string]string{
		"app": cr.Spec.AppName,
	}
...
func NewPostgresqlPVC(cr *iminstallv1alpha1.IMInstall) *corev1.PersistentVolumeClaim {
	labels := map[string]string{
		"app": cr.Spec.AppName,
	}
...
func NewPostgresqlService(cr *iminstallv1alpha1.IMInstall) *corev1.Service {
	labels := map[string]string{
		"app": cr.Spec.AppName,
	}
...
func NewPostgresqlDeployment(cr *iminstallv1alpha1.IMInstall) (*appsv1.Deployment, error) {
