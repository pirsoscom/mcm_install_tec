...
oc delete -n manageiq -f ./tools/infra/manageiq-pods/manageiq-operator/deploy/role.yaml
oc delete -n manageiq -f ./tools/infra/manageiq-pods/manageiq-operator/deploy/role_binding.yaml
oc delete -n manageiq -f ./tools/infra/manageiq-pods/manageiq-operator/deploy/service_account.yaml
oc delete -n manageiq -f ./tools/infra/manageiq-pods/manageiq-operator/deploy/operator.yaml
oc delete -n manageiq -f ./tools/infra/manageiq-pods/manageiq-operator/deploy/kafka-secret.yaml


oc delete secret -n manageiq miq-configuration
oc delete secret -n manageiq miq-secret

oc delete ManageIQ -n manageiq miq
